...
LEGEND_PIC = "https://telegra.ph/file/5c61dd2bfd9c2b5477802.jpg"
...
async def help(event):
    ...
    if event.query.user_id is not bot.uid:
        ...
        await tgbot.send_message(
            ...
            buttons=[
                [
                    Button.url(" Support ", "https://t.me/NoUB_SUPPORT"),
                    Button.url(" Updates ", "https://t.me/NoUB_CHAT"),
                ],
                [
...
async def rel(event):
    if event.query.user_id == bot.uid:
        await event.answer(
            "Reloading Ankitẞø†... Wait for few seconds...", cache_time=0, alert=True
        )
...
async def users(event):
    if event.query.user_id == bot.uid:
        ...
        await tgbot.send_message(
            event.chat_id,
            message=".set var <varname> <value> ex:- .set var ALIVE_NAME Ankit \n\n To Know All Var Go Back And Click On All Var",
            buttons=[
                [custom.Button.inline("Back", data="osg")],
            ],
        )
